...
**_New in 2026_: SpinShuffle Arena** - now in open beta testing.   Arena is a powerful new feature that allows players (whether Android or iOS) to challenge another player and race to complete a puzzle.  The winner gains Elo rating points.  You can join the beta test program [here](https://spinshuffle.net/#arena-beta).
